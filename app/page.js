...
export default function Home() {
  return (
    <main className="flex flex-col justify-center items-center">
      <section className="w-full md:min-h-screen min-h-96 bg-img text-center">
      ...
      <section className="w-full min-h-screen bg-neutral-600 text-center">
        <h1 className="md:text-7xl text-4xl text-neutral-50">Get the best Tattoo, from the Best Artists in Bharat</h1>
      </section>
    </main>
  );
}
